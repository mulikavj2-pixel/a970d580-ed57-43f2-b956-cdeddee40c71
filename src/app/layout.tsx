...
export const metadata: Metadata = {
  title: "CoffeeHub - Premium Coffee Shop & Cafe",
  description: "Discover exceptional coffee at CoffeeHub. Fresh roasted beans, expert brewing, and a welcoming atmosphere since 2015.",
  keywords: "coffee shop, cafe, espresso, cappuccino, premium coffee, coffee beans",
  metadataBase: new URL("https://coffeehub.example.com"),
  alternates: {
    canonical: "https://coffeehub.example.com"
  },
  openGraph: {
    title: "CoffeeHub - Premium Coffee Shop",
    description: "Discover exceptional coffee at CoffeeHub. Fresh roasted beans and expert brewing.",
    siteName: "CoffeeHub",
    type: "website"
  },
  twitter: {
    ...
    title: "CoffeeHub - Premium Coffee Shop",
    description: "Exceptional coffee, crafted with passion"
  },
  robots: {
    index: true,
    follow: true
